...
Public Class frmFuncionario
    ...
    Private Sub btnConsultar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConsultar.Click
        ds = Bll.pesquisaFuncionariosId(txtMatricula.Text, txtFuncionario.Text, txtEndereco.Text, txtBairro.Text, txtTelefoneResidencial.Text, txtTelefoneCelular.Text, txtCargo.Text, txtValorSalario.Text)
    ...
    Private Sub btnAlterar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAlterar.Click
        ...
        Bll.alteraFuncionarios(txtMatricula.Text, txtFuncionario.Text, txtEndereco.Text, txtBairro.Text, txtTelefoneResidencial.Text, txtTelefoneCelular.Text, txtCargo.Text, txtValorSalario.Text)
        carregaGrid()
        limpaDadosForm()
    ...
    Private Sub btnSalvar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSalvar.Click
        Bll.incluiFuncionarios(txtMatricula.Text, txtFuncionario.Text, txtEndereco.Text, txtBairro.Text, txtTelefoneResidencial.Text, txtTelefoneCelular.Text, txtCargo.Text, txtValorSalario.Text)
        carregaGrid()
        limpaDadosForm()
    End Sub

    Private Sub btnExcluir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExcluir.Click
        Bll.excluiFuncionarios(txtMatricula.Text)
        carregaGrid()
        limpaDadosForm()
    End Sub
