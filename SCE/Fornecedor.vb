...
Public Class frmFornecedor
    ...
    Private Sub btnConsultar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConsultar.Click
        If txtBairro.Text = "" Or txtCodigo.Text = "" Or txtContato.Text = "" Or txtEndereco.Text = "" Or txtFornecedor.Text = "" Then
            ds = BllFornecedor.pesquisaFornecedoresId(txtCodigo.Text, txtFornecedor.Text, txtEndereco.Text, txtBairro.Text, txtContato.Text)
    ...
    Private Sub btnAlterar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAlterar.Click
        If validar() = True Then
            ...
            BllFornecedor.alteraFornecedores(txtCodigo.Text, txtFornecedor.Text, txtEndereco.Text, txtBairro.Text, txtContato.Text)
            carregaGrid()
            limpaDadosForm()
        Else
    ...
    Private Sub btnSalvar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSalvar.Click
        If validar() = True And Not (txtCodigo.Text = ds.Tables(0).Rows.Item(0).Item("CD_FORNECEDOR").ToString) Then
            BllFornecedor.incluiFornecedores(txtCodigo.Text, txtFornecedor.Text, txtEndereco.Text, txtBairro.Text, txtContato.Text)
            carregaGrid()
            limpaDadosForm()
        Else
    ...
    Private Sub btnExcluir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExcluir.Click
        If Not (Me.txtCodigo.Text = "") Then
            BllFornecedor.excluiFornecedores(txtCodigo.Text)
            carregaGrid()
            limpaDadosForm()
        Else
