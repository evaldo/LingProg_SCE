...
Public Class frmEntrada
    ...
    Private Sub btnConsultar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConsultar.Click
        ...
        ds = BllEntrada.pesquisaEntradaId(txtCodigoProduto.Text, txtCodigoFornecedor.Text, txtMatricula.Text, txtDataMovimentacao.Text, txtQuantidadeMovimentada.Text)
    ...
    Private Sub btnAlterar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAlterar.Click
        ...
        BllEntrada.alteraEntrada(txtCodigoProduto.Text, txtCodigoFornecedor.Text, txtMatricula.Text, txtDataMovimentacao.Text, txtQuantidadeMovimentada.Text)
        carregaGrid()
        limpaDadosForm()
    ...
    Private Sub btnSalvar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSalvar.Click
        ds = BllProduto.verificaQuantProduto(txtCodigoProduto.Text)
        If ds.Tables(0).Rows.Item(0).Item("QT_MAXIMA") >= txtQuantidadeMovimentada.Text Then
            BllEntrada.incluiEntrada(txtCodigoProduto.Text, txtCodigoFornecedor.Text, txtMatricula.Text, txtDataMovimentacao.Text, txtQuantidadeMovimentada.Text)
            carregaGrid()
            limpaDadosForm()
        Else
    ...
    Private Sub btnExcluir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExcluir.Click
        BllEntrada.excluiEntrada(txtCodigoProduto.Text)
        carregaGrid()
        limpaDadosForm()
    End Sub
