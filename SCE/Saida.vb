...
Public Class frmSaida
    ...
    Private Sub btnSalvar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSalvar.Click
        BllSaida.incluiSaida(txtCodigoProduto.Text, txtCodigoFornecedor.Text, txtMatricula.Text, txtDataMovimentacao.Text, txtQuantidadeMovimentada.Text)
        grdGeral.Visible = True
        grdProduto.Visible = False
        grdFornecedor.Visible = False
        grdFuncionario.Visible = False
    ...
    Private Sub btnExcluir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnExcluir.Click
        BllSaida.excluiSaida(txtCodigoProduto.Text)
        carregaGrid()
        limpaDadosForm()
    End Sub

    Private Sub btnAlterar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAlterar.Click
        BllSaida.alteraSaida(txtCodigoProduto.Text, txtCodigoFornecedor.Text, txtMatricula.Text, txtDataMovimentacao.Text, txtQuantidadeMovimentada.Text)
        carregaGrid()
        limpaDadosForm()
    End Sub

    Private Sub btnConsultar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnConsultar.Click
        ds = BllSaida.pesquisaSaidaId(txtCodigoProduto.Text)
